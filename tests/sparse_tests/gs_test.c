...
#define fp			float
#define OMPSS_GS	ompss_csr_sgs
#define MKL_CSRMV	mkl_scsrmv

#else

#define fp			double
#define OMPSS_GS	ompss_csr_dgs
...
int gs_config(int argc, char *argv[]) 
{
	if ( argc < 3 ) {
...
int main(int argc, char* argv[])
{
	...
	OMPSS_GS(bs, Ahb, v_x0, v_b, max_iter, lookahead, threshold, work);
