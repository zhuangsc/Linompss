...
void ompss_csr_jacobi(int bs, hbmat_t *A,  fp_t *v_x, fp_t *v_b, int max_iter, int lookahead, fp_t threshold, fp_t *work, int *res_p) 
{
	...
	JACOBI_MAIN_CSR(Ahbh, v_x, v_b, bs, max_iter, diagL, lookahead, threshold, work, res_p);
