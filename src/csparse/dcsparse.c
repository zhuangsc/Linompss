...
#define cs_add cs_add_double 
#define cs_cholsol cs_cholsol_double 
#define cs_cholsol2 cs_cholsol2_double 
#define cs_dupl cs_dupl_double 
#define cs_entry cs_entry_double 
#define cs_lusol cs_lusol_double 
#define cs_gaxpy cs_gaxpy_double 
#define cs_multiply cs_multiply_double 
#define cs_qrsol cs_qrsol_double 
#define cs_transpose cs_transpose_double 
#define cs_triplet cs_triplet_double 
#define cs_norm cs_norm_double 
#define cs_print cs_print_double 
#define cs_load cs_load_double 

#define cs_calloc cs_calloc_double 
#define cs_free cs_free_double 
#define cs_realloc cs_realloc_double 
#define cs_spalloc cs_spalloc_double 
#define cs_spfree cs_spfree_double 
#define cs_sprealloc cs_sprealloc_double 
#define cs_malloc cs_malloc_double 

#define cs_amd cs_amd_double 
#define cs_chol cs_chol_double 
#define cs_dmperm cs_dmperm_double 
#define cs_droptol cs_droptol_double 
#define cs_dropzeros cs_dropzeros_double 
#define cs_happly cs_happly_double 
#define cs_ipvec cs_ipvec_double 
#define cs_lsolve cs_lsolve_double 
#define cs_ltsolve cs_ltsolve_double 
#define cs_lu cs_lu_double 
#define cs_permute cs_permute_double 
#define cs_pinv cs_pinv_double 
#define cs_pvec cs_pvec_double 
#define cs_qr cs_qr_double 
#define cs_schol cs_schol_double 
#define cs_sqr cs_sqr_double 
#define cs_symperm cs_symperm_double 
#define cs_usolve cs_usolve_double 
#define cs_utsolve cs_utsolve_double 
#define cs_updown cs_updown_double 

#define cs_sfree cs_sfree_double 
#define cs_nfree cs_nfree_double 
#define cs_dfree cs_dfree_double 

#define cs_counts cs_counts_double 
#define cs_cumsum cs_cumsum_double 
#define cs_dfs cs_dfs_double 
#define cs_etree cs_etree_double 
#define cs_fkeep cs_fkeep_double 
#define cs_house cs_house_double 
#define cs_maxtrans cs_maxtrans_double 
#define cs_post cs_post_double 
#define cs_reach cs_reach_double 
#define cs_scc cs_scc_double 
#define cs_scatter cs_scatter_double 
#define cs_splsolve cs_splsolve_double 
#define cs_tdfs cs_tdfs_double 

#define cs_dalloc cs_dalloc_double 
#define cs_done cs_done_double 
#define cs_idone cs_idone_double 
#define cs_ndone cs_ndone_double 
#define cs_ddone cs_ddone_double 
...
*/
{
    ...
    x = values ? cs_malloc (m, sizeof (double)) : 0 ;
...
cs *cs_spalloc (int m, int n, int nzmax, int values, int triplet)
{
    ...
    A->x = values ? cs_malloc (nzmax, sizeof (double)) : 0 ;
